...
public class OrderRollBack4Open_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrderRollBack4Open_AIProcess.class);
  protected void executeInner(IOVOrderCustomer newOvOrderCustomer,IOVOrderCustomer oldOvOrderCustomer) throws Exception{
	String _TASK_JUGE_RESULT = "";
    ((com.asiainfo.crm.so.common.service.interfaces.IOrderRollBack4InterfaceSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.asiainfo.crm.so.common.service.interfaces.IOrderRollBack4InterfaceSV",com.asiainfo.crm.so.common.service.interfaces.IOrderRollBack4InterfaceSV.class)).openPort(oldOvOrderCustomer,newOvOrderCustomer);
  }
