...
public class OrdNewProd4CustPlan_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdNewProd4CustPlan_AIProcess.class);
