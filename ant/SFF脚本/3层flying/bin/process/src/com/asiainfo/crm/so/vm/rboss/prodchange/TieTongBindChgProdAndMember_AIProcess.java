...
public class TieTongBindChgProdAndMember_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(TieTongBindChgProdAndMember_AIProcess.class);
