...
public class OrdAddIncOfferForMsm_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdAddIncOfferForMsm_AIProcess.class);
