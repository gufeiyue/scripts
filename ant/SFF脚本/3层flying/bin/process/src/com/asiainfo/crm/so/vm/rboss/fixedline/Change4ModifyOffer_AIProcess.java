...
public class Change4ModifyOffer_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(Change4ModifyOffer_AIProcess.class);
