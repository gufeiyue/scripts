...
public class OrdTransTrackIns_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdTransTrackIns_AIProcess.class);
  protected void executeInner(List ordTransTrackList,String REGION_ID) throws Exception{
    ...
    while(ordTransTrackList != null && aOrdxTransTrackIdx < ordTransTrackList.size()){
      ...
      logger.warn("Configure the node (转轨迹实例)");
      aOrdxTransTrackIdx++;
    }
  }
