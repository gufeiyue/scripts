...
public class OrdNewProd_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdNewProd_AIProcess.class);
  protected IOVOrderCustomer executeInner(long customerOrderId,IOVOrderOffer[] aOVOrderOffers,String REGION_ID,String ICCID,String IMSI) throws Exception{
    ...
    ((com.asiainfo.crm.so.order.rboss.service.interfaces.IOfferExtendSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.asiainfo.crm.so.order.rboss.service.interfaces.IOfferExtendSV",com.asiainfo.crm.so.order.rboss.service.interfaces.IOfferExtendSV.class)).savePrecipitationData(aOVOrderCustomer,(com.ai.omframe.order.ivalues.IOVOrderOffer)VMDataType.transfer(aOVOrderOffers,com.ai.omframe.order.ivalues.IOVOrderOffer.class));
    ((com.asiainfo.crm.so.order.rboss.service.interfaces.IOfferExtendSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.asiainfo.crm.so.order.rboss.service.interfaces.IOfferExtendSV",com.asiainfo.crm.so.order.rboss.service.interfaces.IOfferExtendSV.class)).saveUserOfferExtend(aOVOrderCustomer,(com.ai.omframe.order.ivalues.IOVOrderOffer)VMDataType.transfer(aOVOrderOffers,com.ai.omframe.order.ivalues.IOVOrderOffer.class));
    ((com.asiainfo.crm.so.common.service.interfaces.ISmsSendSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.asiainfo.crm.so.common.service.interfaces.ISmsSendSV",com.asiainfo.crm.so.common.service.interfaces.ISmsSendSV.class)).openUserSendSms(aOVOrderCustomer);
  ...
  public IOVOrderCustomer execute(long customerOrderId,IOVOrderOffer[] aOVOrderOffers,String REGION_ID,String ICCID,String IMSI) throws Exception{
    ...
    $inParameter.put("IMSI",IMSI);
try{
    IOVOrderCustomer realReturn = executeInner( customerOrderId, aOVOrderOffers, REGION_ID, ICCID, IMSI);
...
if(e instanceof RuntimeException){
 ...
 throw new RuntimeException(e);
  ...
  public Map execute(Map $vmParameters) throws Exception{
    ...
    String IMSI = ($vmParameters.get("IMSI") == null)?"":(String)VMDataType.transfer($vmParameters.get("IMSI"),String.class);
IOVOrderCustomer realReturn = execute(customerOrderId,aOVOrderOffers,REGION_ID,ICCID,IMSI);
