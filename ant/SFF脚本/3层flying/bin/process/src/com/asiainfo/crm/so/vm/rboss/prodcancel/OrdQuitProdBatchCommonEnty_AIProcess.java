...
public class OrdQuitProdBatchCommonEnty_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdQuitProdBatchCommonEnty_AIProcess.class);
  protected IOVOrderCustomer executeInner(long customerOrderId,IOVOrderCustomer aOVOrderCustomer,String REGION_ID) throws Exception{
    ...
    aSoOrderData=com.ai.omframe.util.SoServiceFactory.getOrderVmHelperSV().getSoOrderDataByCustOrdId(customerOrderId);;
    ...
    ((com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV",com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV.class)).preDestroyQuitGroup(customerOrderId);
    ((com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV",com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV.class)).quitOfferVasForPreDestroy(customerOrderId);
    ...
    aOVOrderCustomer.getOVOrderOffers()[0].getOVOrdOffOrdUser()[0].addOrdUserOsStateValue(aOrdUserOsStateValue);aOrdUserOsStateValue.setOsStatusPre(aOrdUserOsStateValue.getOsStatus());aOrdUserOsStateValue.setOsStatus(com.asiainfo.crm.so.util.RbossServiceFactory.getStopOpenOsStatusSV().setOsStatus(aOrdUserOsStateValue.getOsStatus(),29,"1")); String insState=com.asiainfo.crm.so.common.RBossConst.USER_STATE_SO_PRE_DESTROY;long businessId=aOVOrderCustomer.getOrderCustomerValue().getBusinessId(); if(businessId==com.asiainfo.crm.so.common.RBossConst.BUSI_ID_ACCT_PREDESTROY){insState=com.asiainfo.crm.so.common.RBossConst.USER_STATE_ACCT_PRE_DESTROY;} aOrdUserValue.setInsState(Integer.parseInt(insState));aOrdUserValue.setPreDestoryTime(com.ai.appframe2.common.ServiceManager.getIdGenerator().getSysDate());;
    ((com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV",com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV.class)).setPreDestroyTime(aOrdUserValue,customerOrderId);
    ...
    ((com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV",com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV.class)).dealBusinessForPreDestroyUser(customerOrderId);
    ((com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV",com.asiainfo.crm.so.instance.rboss.service.interfaces.IQuitProdSV.class)).orderBalTrans(customerOrderId);
