...
public class orderRollBack4Billing_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(orderRollBack4Billing_AIProcess.class);
  protected void executeInner(IOVOrderCustomer newOvOrderCustomer,IOVOrderCustomer oldOvOrderCustomer) throws Exception{
    ...
    toBillIngMap = ((com.asiainfo.crm.so.common.service.interfaces.IOrderRollBack4InterfaceSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.asiainfo.crm.so.common.service.interfaces.IOrderRollBack4InterfaceSV",com.asiainfo.crm.so.common.service.interfaces.IOrderRollBack4InterfaceSV.class)).freeValueMapForOpen(newOvOrderCustomer,toBillIngMap);
    ((com.asiainfo.crm.so.common.service.interfaces.IOrderRollBack4InterfaceSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.asiainfo.crm.so.common.service.interfaces.IOrderRollBack4InterfaceSV",com.asiainfo.crm.so.common.service.interfaces.IOrderRollBack4InterfaceSV.class)).billingPort(oldOvOrderCustomer,newOvOrderCustomer,toBillIngMap);
  }
