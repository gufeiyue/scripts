...
public class OrdNewOffer_AIProcess implements ProcessInstance{
  ...
  protected long executeInner(long customerOrderId,long soUserDataKey,IOVOrderCustomer aOVOrderCustomer,String workflowId,String REGION_ID) throws Exception{
  ...
  public long execute(long customerOrderId,long soUserDataKey,IOVOrderCustomer aOVOrderCustomer,String workflowId,String REGION_ID) throws Exception{
...
try{
    long realReturn = executeInner( customerOrderId, soUserDataKey, aOVOrderCustomer, workflowId, REGION_ID);
...
long realReturn = execute(customerOrderId,soUserDataKey,aOVOrderCustomer,workflowId,REGION_ID);
