...
public class OrdUpdIncOfferForEmail_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdUpdIncOfferForEmail_AIProcess.class);
