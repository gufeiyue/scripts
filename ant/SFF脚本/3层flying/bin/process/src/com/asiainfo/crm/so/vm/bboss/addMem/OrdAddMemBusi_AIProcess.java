...
public class OrdAddMemBusi_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdAddMemBusi_AIProcess.class);
  protected long executeInner(long realBusinessId,long customerOrderId,long soUserDataKey,String workflowId,String REGION_ID) throws Exception{
    ...
    {//Call the sub-processes增加成员
      ...
      tmpMap13.put("realBusinessId",new Long(realBusinessId));
      tmpMap13.put("REGION_ID",REGION_ID);

      com.ai.comframe.vm.processflow.ProcessEngineFactory.getProcessEngine().executeProcess("com.ai.omframe.order.vm.lib1.OrdAddMem",tmpMap13);
