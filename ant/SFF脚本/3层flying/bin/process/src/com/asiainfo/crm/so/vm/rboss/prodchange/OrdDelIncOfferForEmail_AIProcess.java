...
public class OrdDelIncOfferForEmail_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdDelIncOfferForEmail_AIProcess.class);
