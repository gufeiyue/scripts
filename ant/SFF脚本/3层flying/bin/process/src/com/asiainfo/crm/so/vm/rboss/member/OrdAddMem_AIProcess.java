...
public class OrdAddMem_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdAddMem_AIProcess.class);
  protected void executeInner(long soUserDataKey,long realBusinessId,String REGION_ID,IOVOrderCustomer aOVOrderCustomer,long customerOrderId) throws Exception{
    ...
    {//Call the sub-processes增加成员
      ...
      com.ai.comframe.vm.processflow.ProcessEngineFactory.getProcessEngine().executeProcess("com.ai.omframe.order.vm.lib1.OrdAddMem",tmpMap6);
