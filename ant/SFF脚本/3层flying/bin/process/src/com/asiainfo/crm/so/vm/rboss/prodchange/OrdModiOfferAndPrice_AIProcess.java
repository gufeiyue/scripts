...
public class OrdModiOfferAndPrice_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdModiOfferAndPrice_AIProcess.class);
  protected IOVOrderOffer executeInner(ISoOfferData aSoOfferData,ISoUserData aSoUserData,OrderValueChain aOrderValueChain,IOVOrderCustomer aOVOrderCustomer,String REGION_ID) throws Exception{
	...
	long aOfferInstId = 0;
	long userId = 0;
    aOrderValueChain.setSTATE_OFFER(com.ai.omframe.order.valuebean.OrderConst.DATA_MODIFY_STATE);aOfferInstId=aSoOfferData.getInsOfferId();userId=aSoUserData.getUserId();
