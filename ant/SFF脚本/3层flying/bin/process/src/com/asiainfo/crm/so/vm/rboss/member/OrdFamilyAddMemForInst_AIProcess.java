...
public class OrdFamilyAddMemForInst_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdFamilyAddMemForInst_AIProcess.class);
  protected void executeInner(long customerOrderId,long soUserDataKey,long realBusinessId,String REGION_ID,IOVOrderCustomer aOVOrderCustomer,long mainMemberUserId) throws Exception{
    ...
    {//Call the sub-processes增加成员
      ...
      com.ai.comframe.vm.processflow.ProcessEngineFactory.getProcessEngine().executeProcess("com.ai.omframe.order.vm.lib1.OrdAddMem",tmpMap11);
