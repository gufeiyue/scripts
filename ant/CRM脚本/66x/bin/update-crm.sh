...
#svn co -r HEAD --username deploy-scm --password ailkscm http://10.11.20.110/svn/VERIS-CRM-COREV6.6/branch/V6.6.2-rm-SR0.3/CRM ../svn/CRM
svn --no-auth-cache up -r HEAD --username deploy-scm --password ailkscm ../svn/CRM
...
echo "BEGIN TO RESOLVE nReport662!!!!"
cp  -rf  ../svn/CRM/nReport662/src/main/java/*                 ../svn/crm/src
cp  -rf  ../svn/CRM/nReport662/src/main/config/*       ../svn/crm/config
...
#svn co --force -r HEAD --username zhouwei13 --password zhouwei http://10.11.20.110/svn/VERIS-CRM-COREV6.6/run-time-config-v662/release-SR0.3/t_21/crm_app ../config/21/runtime-config/crm_app
#svn co --force -r HEAD --username zhouwei13 --password zhouwei http://10.11.20.110/svn/VERIS-CRM-COREV6.6/run-time-config-v662/release-SR0.3/t_21/crm_web ../config/21/runtime-config/crm_web
#svn co --force -r HEAD --username zhouwei13 --password zhouwei http://10.11.20.110/svn/VERIS-CRM-COREV6.6/run-time-config-v662/release-SR0.3/t_21/crm_exe ../config/21/runtime-config/crm_exe
#svn co --force -r HEAD --username zhouwei13 --password zhouwei http://10.11.20.110/svn/VERIS-CRM-COREV6.6/run-time-config-v662/release-SR0.3/t_21/crm_inter ../config/21/runtime-config/crm_inter


svn --no-auth-cache up --force -r HEAD --username zhouwei13 --password zhouwei  ../config/21/runtime-config/crm_app
svn --no-auth-cache up --force -r HEAD --username zhouwei13 --password zhouwei  ../config/21/runtime-config/crm_web
svn --no-auth-cache up --force -r HEAD --username zhouwei13 --password zhouwei  ../config/21/runtime-config/crm_exe
svn --no-auth-cache up --force -r HEAD --username zhouwei13 --password zhouwei  ../config/21/runtime-config/crm_inter
