...
public class OrdMainOfferCreateUser_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdMainOfferCreateUser_AIProcess.class);
  protected IOVOrderOffer executeInner(ISoUserData aSoUserData,IOVOrderCustomer aOVOrderCustomer,ISoOfferData aSoOfferData,OrderValueChain aOrderValueChain,String REGION_ID,long custId) throws Exception{
    ...
    aSoOfferData=aSoUserData.getSoRoleData().getSoOfferData(); ((com.asiainfo.crm.so.order.rboss.service.interfaces.IChgOwnerShipSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.asiainfo.crm.so.order.rboss.service.interfaces.IChgOwnerShipSV",com.asiainfo.crm.so.order.rboss.service.interfaces.IChgOwnerShipSV.class)).addUserAcctInfoDcBySoOfferData(aSoOfferData, aSoUserData);;
    ...
    aOrdOfferValue = aOVOrderOffer.getOrderOfferValue(); aOrdOfferValue.setCustId(custId); com.asiainfo.crm.so.util.RbossServiceFactory.getPrjOrderVmHelper().setOrdUserValueForChgCustOwner(aOrdUserValue,custId);;
  ...
  public IOVOrderOffer execute(ISoUserData aSoUserData,IOVOrderCustomer aOVOrderCustomer,ISoOfferData aSoOfferData,OrderValueChain aOrderValueChain,String REGION_ID,long custId) throws Exception{
...
try{
    IOVOrderOffer realReturn = executeInner( aSoUserData, aOVOrderCustomer, aSoOfferData, aOrderValueChain, REGION_ID, custId);
...
IOVOrderOffer realReturn = execute(aSoUserData,aOVOrderCustomer,aSoOfferData,aOrderValueChain,REGION_ID,custId);
