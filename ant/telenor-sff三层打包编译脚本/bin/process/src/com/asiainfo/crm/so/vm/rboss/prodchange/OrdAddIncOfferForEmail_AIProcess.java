...
public class OrdAddIncOfferForEmail_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdAddIncOfferForEmail_AIProcess.class);
