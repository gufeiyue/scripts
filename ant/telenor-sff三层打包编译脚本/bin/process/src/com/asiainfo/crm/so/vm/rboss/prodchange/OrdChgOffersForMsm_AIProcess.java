...
public class OrdChgOffersForMsm_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdChgOffersForMsm_AIProcess.class);
