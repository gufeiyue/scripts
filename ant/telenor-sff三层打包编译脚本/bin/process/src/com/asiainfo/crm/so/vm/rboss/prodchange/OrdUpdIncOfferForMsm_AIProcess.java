...
public class OrdUpdIncOfferForMsm_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdUpdIncOfferForMsm_AIProcess.class);
