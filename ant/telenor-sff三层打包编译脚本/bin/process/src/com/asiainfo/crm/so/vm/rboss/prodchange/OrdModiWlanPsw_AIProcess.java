...
public class OrdModiWlanPsw_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdModiWlanPsw_AIProcess.class);
  protected IOVOrderCustomer executeInner(long soUserDataKey,IOVOrderCustomer aOVOrderCustomer,String REGION_ID) throws Exception{
    ...
    ((com.asiainfo.crm.so.order.dsmp.service.interfaces.IDsmpSoSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.asiainfo.crm.so.order.dsmp.service.interfaces.IDsmpSoSV",com.asiainfo.crm.so.order.dsmp.service.interfaces.IDsmpSoSV.class)).dealAllNetWlanPswRealTime(aSoUserData,aSoOfferData);
