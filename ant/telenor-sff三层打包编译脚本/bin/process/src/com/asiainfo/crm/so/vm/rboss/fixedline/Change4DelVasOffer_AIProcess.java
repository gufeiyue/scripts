...
public class Change4DelVasOffer_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(Change4DelVasOffer_AIProcess.class);
  protected IOVOrderCustomer executeInner(long soUserDataKey,String REGION_ID,IOVOrderCustomer aOVOrderCustomer) throws Exception{
    ...
    {//Call the sub-processes退订增值策划
      ...
      com.ai.comframe.vm.processflow.ProcessEngineFactory.getProcessEngine().executeProcess("com.ai.omframe.order.vm.lib1.OrdDropOffer",tmpMap3);
