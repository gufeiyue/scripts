...
public class Change4AddVasOffer_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(Change4AddVasOffer_AIProcess.class);
