...
public class OrdDelIncOfferForMsm_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdDelIncOfferForMsm_AIProcess.class);
