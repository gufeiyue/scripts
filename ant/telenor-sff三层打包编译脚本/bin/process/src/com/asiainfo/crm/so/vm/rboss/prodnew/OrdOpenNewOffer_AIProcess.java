...
public class OrdOpenNewOffer_AIProcess implements ProcessInstance{
  ...
  protected IOVOrderOffer executeInner(ISoUserData aSoUserData,IOVOrderCustomer aOVOrderCustomer,ISoOfferData aSoOfferData,OrderValueChain aOrderValueChain,String REGION_ID) throws Exception{
    ...
    aOrdUserValue.setState(4);if( null!=aOVOrderCustomer.getOVOrderOffers()){if(aOVOrderCustomer.getOVOrderOffers().length>0){if( null!=aOVOrderCustomer.getOVOrderOffers()[0].getOVOrdOffOrdUser()){if(aOVOrderCustomer.getOVOrderOffers()[0].getOVOrdOffOrdUser().length>0){if( null!=aOVOrderCustomer.getOVOrderOffers()[0].getOVOrdOffOrdUser()[0].getOrdUserValues()){if(aOVOrderCustomer.getOVOrderOffers()[0].getOVOrdOffOrdUser()[0].getOrdUserValues().length>0){aOrdUserValue.setSubBillId(aOVOrderCustomer.getOVOrderOffers()[0].getOVOrdOffOrdUser()[0].getOrdUserValues()[0].getSubBillId());}}}}}};
    ...
    {//Call the sub-processesDeal Commitment
      ...
      tmpMap19.clear();
      tmpMap19.put("aSoOfferData",aSoOfferData);
      ...
      com.ai.comframe.vm.processflow.ProcessEngineFactory.getProcessEngine().executeProcess("com.ai.omframe.order.vm.lib0.OrdCommitment",tmpMap19);
