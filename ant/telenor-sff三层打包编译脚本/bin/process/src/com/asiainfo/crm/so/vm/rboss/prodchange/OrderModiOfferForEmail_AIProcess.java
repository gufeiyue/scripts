...
public class OrderModiOfferForEmail_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrderModiOfferForEmail_AIProcess.class);
