...
public class OrdTransInsForRegion_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdTransInsForRegion_AIProcess.class);
  protected IOVOrderCustomer executeInner(IOVOrderCustomer aOVOrderCustomer,String REGION_ID) throws Exception{
    ...
    while(aOVOrderOffers!=null&&aOVOrderOfferIdx<aOVOrderOffers.length){
      ...
      {//Call the sub-processesTransInsUnitForRegion
        ...
        com.ai.comframe.vm.processflow.ProcessEngineFactory.getProcessEngine().executeProcess("com.asiainfo.crm.so.vm.rboss.prodnew.TransInsUnitForRegion",tmpMap3);
