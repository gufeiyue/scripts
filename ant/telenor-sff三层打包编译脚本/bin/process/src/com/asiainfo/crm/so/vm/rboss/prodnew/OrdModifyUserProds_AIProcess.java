...
public class OrdModifyUserProds_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdModifyUserProds_AIProcess.class);
  protected void executeInner(long customerOrderId,IOVOrderCustomer aOVOrderCustomer,String REGION_ID) throws Exception{
    ...
    aOrdUserOsStateValue.setOsStatus(com.ai.omframe.order.valuebean.OrderConst.OS_STATUS); aOrdUserOsStateValue.setState(com.ai.omframe.order.valuebean.OrderConst.DATA_MODIFY_STATE);;
