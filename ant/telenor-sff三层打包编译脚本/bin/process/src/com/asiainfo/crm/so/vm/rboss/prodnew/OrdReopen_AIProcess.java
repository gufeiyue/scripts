...
public class OrdReopen_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdReopen_AIProcess.class);
  protected IOVOrderOffer executeInner(long customerOrderId,IOVOrderCustomer aOVOrderCustomer,String workflowId,String REGION_ID) throws Exception{
  ...
  public IOVOrderOffer execute(long customerOrderId,IOVOrderCustomer aOVOrderCustomer,String workflowId,String REGION_ID) throws Exception{
...
try{
    IOVOrderOffer realReturn = executeInner( customerOrderId, aOVOrderCustomer, workflowId, REGION_ID);
...
IOVOrderOffer realReturn = execute(customerOrderId,aOVOrderCustomer,workflowId,REGION_ID);
