...
public class OrdChangeOffer_AIProcess implements ProcessInstance{
  private static transient Log logger = LogFactory.getLog(OrdChangeOffer_AIProcess.class);
  protected IOVOrderCustomer executeInner(ISoOfferData aNewSoOfferData,IOVOrderCustomer aOVOrderCustomer,OrderValueChain aOrderValueChain,String REGION_ID) throws Exception{
    ...
    aNewSoUserData=aNewSoOfferData.getSoRoleData()[0].getSoUserData()[0];;
    aOldSoOfferData = ((com.ai.omframe.order.service.interfaces.IOrderVmHelperSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.ai.omframe.order.service.OrderVmHelperSV",com.ai.omframe.order.service.interfaces.IOrderVmHelperSV.class)).createSoOfferDataFromOfferInstId(aOfferInstId,REGION_ID);
    aBillId=aNewSoUserData.getBillId();;
    java.sql.Timestamp validDate=aNewSoOfferData.getValidDate(); java.sql.Timestamp expireDate=new java.sql.Timestamp(validDate.getTime()-1000); aOldSoOfferData.setExpireDate(expireDate); aOldSoOfferData.setParentBceData(aNewSoOfferData.getSoOrderData()); aNewSoOfferData.getSoOrderData().addSubData(aOldSoOfferData);;
    oldOfferId=aOldSoOfferData.getOfferId(); newOfferId=aNewSoOfferData.getOfferId();;
    oldDropBusinessId = ((com.ai.omframe.order.service.interfaces.IOrderVmHelperSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.ai.omframe.order.service.OrderVmHelperSV",com.ai.omframe.order.service.interfaces.IOrderVmHelperSV.class)).getOfferBusinessId(oldOfferId,"LOGOUT");
    newCreateBusinessId = ((com.ai.omframe.order.service.interfaces.IOrderVmHelperSV)com.ai.comframe.vm.common.ServiceUtil.getService("com.ai.omframe.order.service.OrderVmHelperSV",com.ai.omframe.order.service.interfaces.IOrderVmHelperSV.class)).getOfferBusinessId(newOfferId,"CREATE");
    aOldSoOfferData.setBusinessId(oldDropBusinessId); aNewSoOfferData.setBusinessId(newCreateBusinessId);;
