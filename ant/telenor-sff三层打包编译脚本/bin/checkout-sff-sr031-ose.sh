...
svn co --force -r HEAD --username tangs3 --password sfframe111 http://10.11.20.110/svn/VERIS-CRM-COREV6.6/trunk/V6.6.2-dev/OSS/runtime_config/SR0.3.1Exe ../config/runtime-config/sff_exe
